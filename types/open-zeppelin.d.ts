...
// adds types we use from @openzeppelin/test-helpers
// a module was started here: https://github.com/DefinitelyTyped/DefinitelyTyped/pull/43172/files and some of the below is taken from there
// but never completed. Ongoing work is happening to add types here: https://github.com/OpenZeppelin/openzeppelin-test-helpers/pull/141
// but we define our own types until this is ready
declare module '@openzeppelin/test-helpers/configure' {
    import { provider } from 'web3-core';

    export interface Config {
        provider?: provider,
        singletons?: {
            abstraction?: "truffle" | "web3",
            defaultGas?: number,
            defaultSender?: string
        }
        enviornment?: "truffle" | "web3"
    }

    // TODO: define the default function here
