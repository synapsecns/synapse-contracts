 ...
 * @notice A library to calculate and ramp the A parameter of a given `SwapUtils08.Swap` struct.
 * This library assumes the struct is fully validated.
 */
library AmplificationUtils08 {
     ...
     * @return A parameter
     */
    function getA(SwapUtils08.Swap storage self) external view returns (uint256) {
     ...
     */
    function getAPrecise(SwapUtils08.Swap storage self) external view returns (uint256) {
     ...
     * @return A parameter in its raw precision form
     */
    function _getAPrecise(SwapUtils08.Swap storage self) internal view returns (uint256) {
     ...
     * @param self Swap struct to update
     */
    function stopRampA(SwapUtils08.Swap storage self) external {
