...
import "./OwnerPausableUpgradeable08.sol";
import "./libraries/SwapUtils08.sol";
import "./libraries/AmplificationUtils08.sol";

/**
 * @title Swap - A StableSwap implementation in solidity.
 *
 * @notice SUPER-DUPER IMPORTANT. This code is NOT tested THOROUGHLY. This is literally a
 * lame copy-pasta, made specifically for testing in 0.8+ Foundry environment. DO NOT use this w/o doing
 * testing first.
 *
 ...
 *
 * @dev Most of the logic is stored as a library `SwapUtils08` for the sake of reducing contract's
 * deployment size.
 */
contract Swap08 is OwnerPausableUpgradeable08, ReentrancyGuardUpgradeable {
    using SafeERC20 for IERC20;
    using SwapUtils08 for SwapUtils08.Swap;
    using AmplificationUtils08 for SwapUtils08.Swap;

    // Struct storing data responsible for automatic market maker functionalities. In order to
    // access this data, this contract uses SwapUtils08 library. For more details, see SwapUtils08.sol
    SwapUtils08.Swap public swapStorage;
    ...
    // events replicated from SwapUtils08 to make the ABI easier for dumb
    // clients
    ...
    function initialize(
        ...
        for (uint8 i = 0; i < _pooledTokens.length; i++) {
            ...
            require(decimals[i] <= SwapUtils08.POOL_PRECISION_DECIMALS, "Token decimals exceeds max");
            precisionMultipliers[i] = 10**(SwapUtils08.POOL_PRECISION_DECIMALS - decimals[i]);
            tokenIndexes[address(_pooledTokens[i])] = i;
        }

        // Check _a, _fee, _adminFee parameters
        require(_a < AmplificationUtils08.MAX_A, "_a exceeds maximum");
        require(_fee < SwapUtils08.MAX_SWAP_FEE, "_fee exceeds maximum");
        require(_adminFee < SwapUtils08.MAX_ADMIN_FEE, "_adminFee exceeds maximum");

        // Clone and initialize a LPToken contract
        LPToken08 lpToken = LPToken08(Clones.clone(lpTokenTargetAddress));
        ...
        swapStorage.initialA = _a * AmplificationUtils08.A_PRECISION;
        swapStorage.futureA = _a * AmplificationUtils08.A_PRECISION;
