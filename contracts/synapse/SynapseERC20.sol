...
contract SynapseERC20 is Initializable, ContextUpgradeable, AccessControlUpgradeable, ERC20BurnableUpgradeable, ERC20PermitUpgradeable {
     ...
     */
    function initialize(string memory _name, string memory _symbol, uint8 _decimals, uint256 _underlyingChainId, address _underlyingTokenAddress, address _owner) public initializer {
