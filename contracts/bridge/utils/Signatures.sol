...
//    {
//
//        return verifySignature(signingPubKeyX, pubKeyYParity, signature, msgHash, nonceTimesGeneratorAddress);
//        // TODO: the below is not working right now (despite appearing identical) fix this
...
//    }
     ...
     *
     * @param signingPubKeyX is the x ordinate of the public key. This must be less than HALF_Q.
     * @param pubKeyYParity is 0 if the y ordinate of the public key is even, 1 if it's odd.
