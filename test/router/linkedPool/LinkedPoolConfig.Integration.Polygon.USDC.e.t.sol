...
contract LinkedPoolConfigUSDCePolygonTestFork is LinkedPoolConfigIntegrationTest {
    ...
    constructor() LinkedPoolConfigIntegrationTest("polygon", "USDC.e", SWAP_VALUE, MAX_PERCENT_DELTA) {}
}
