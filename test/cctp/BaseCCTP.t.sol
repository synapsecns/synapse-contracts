...
abstract contract BaseCCTPTest is MessageTransmitterEvents, TokenMessengerEvents, SynapseCCTPEvents, Test {
    ...
    function getExpectedKappa(
        ...
        bytes memory formattedRequest = RequestLib.formatRequest({
            ...
            baseRequest_: RequestLib.formatBaseRequest({
                originDomain_: originDomain,
                nonce_: nonce,
                originBurnToken_: originBurnToken,
                amount_: amount,
                recipient_: finalRecipient
            }),
            swapParams_: swapParams
        });
    ...
    function getExpectedRequest(
        ...
        expectedRequest = RequestLib.formatRequest({
            ...
            baseRequest_: RequestLib.formatBaseRequest({
                originDomain_: originDomain,
                nonce_: cctpSetups[originDomain].messageTransmitter.nextAvailableNonce(),
                originBurnToken_: address(cctpSetups[DOMAIN_ETH].mintBurnToken),
                amount_: amount,
