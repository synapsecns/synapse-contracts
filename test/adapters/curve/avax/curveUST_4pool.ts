...
describe(ADAPTER_NAME, function () {
  ...
  const tokenSymbols = ["UST", "FRAX", "USDC", "USDT"]
  const poolTokenSymbols = ["UST", "FRAX", "USDC", "USDT"]
  ...
  before(async function () {
    // 2022-05-05
    await forkChain(process.env.AVAX_API, 14300000)
