...
import {SynapseRouterSuite, SynapseRouterEndToEndEdgeCasesTest} from "../SynapseRouterEndToEndEdgeCases.t.sol";
import {SwapQuoterV2Setup} from "./SwapQuoterV2Setup.t.sol";

contract SynapseRouterEndToEndEdgeCasesWithQuoterV2Test is SwapQuoterV2Setup, SynapseRouterEndToEndEdgeCasesTest {
