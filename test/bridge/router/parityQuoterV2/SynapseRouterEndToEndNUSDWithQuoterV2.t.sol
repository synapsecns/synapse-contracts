...
import {SynapseRouterSuite, SynapseRouterEndToEndNUSDTest} from "../SynapseRouterEndToEndNUSD.t.sol";
import {SwapQuoterV2Setup} from "./SwapQuoterV2Setup.t.sol";

contract SynapseRouterEndToEndNUSDWithQuoterV2Test is SwapQuoterV2Setup, SynapseRouterEndToEndNUSDTest {
