...
import {SynapseRouterEndToEndNETHTest, SynapseRouterSuite} from "../SynapseRouterEndToEndNETH.t.sol";

contract SynapseRouterEndToEndNETHWithBothTest is QuoterV2WithLinkedPoolSetup, SynapseRouterEndToEndNETHTest {
