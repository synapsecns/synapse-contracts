...
describe("Avax Jewel Migration", async function () {
  ...
  let migrator: AvaxJewelMigration
  ...
  beforeEach(async function () {
    ...
    let migratorFactory = await ethers.getContractFactory("AvaxJewelMigration")
    migrator = (await migratorFactory.deploy()) as AvaxJewelMigration
