...
import { SynapseERC20, AvaxJewelSwap, SynapseBridge } from "../../../build/typechain";
...
describe("Avax Jewel Migration", async function () {
  ...
  beforeEach(async function () {
    ...
    await network.provider.send("hardhat_setBalance", [VALIDATOR, "0xFFFFFFFFFFFFFFFFFFFF"]);
  });

  it("Swap reverts", async function () {
    await expect(swap.swap(0, 1, 1, 0, MAX_UINT256)).to.be.revertedWith("There is no swap");
  });
