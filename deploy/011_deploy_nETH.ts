...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (includes([CHAIN_ID.ARBITRUM, CHAIN_ID.HARDHAT, CHAIN_ID.BOBA, CHAIN_ID.OPTIMISM, CHAIN_ID.AVALANCHE, CHAIN_ID.HARMONY, CHAIN_ID.FANTOM, CHAIN_ID.METIS], await getChainId())) {
