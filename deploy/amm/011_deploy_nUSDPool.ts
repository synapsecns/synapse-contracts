...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  if (nUSDPool) {
    ...
    const nusdSwapDepositAddress =
      newPoolEvent["args"]["metaSwapDepositAddress"]
    log(`deployed nUSD pool clone (targeting "nUSDPool") at ${nusdSwapAddress}`)
    ...
    const lpTokenAddress = (await read("nUSDPool", "swapStorage")).lpToken
