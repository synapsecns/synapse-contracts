...
# Test contracts ending with exactly "TestCanto" require Canto RPC and block number: 2022-11-24
forge test --match-contract "$1.*TestCanto$" --fork-url $CANTO_API --fork-block-number 1780000 -vvv || exit 1